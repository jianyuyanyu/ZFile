...
namespace ZTAppFrameword.Template.Converters
{
    ...
    internal class RingProgressBarConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if(width==0 || height==0) return new object[] { DependencyProperty.UnsetValue, DependencyProperty.UnsetValue };
            double radius = 0;
    ...
    internal class ProgressBarPercentConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return Math.Round(Math.Round((value - min) / (max - min), 2) * 100,2) + "%";
        }
