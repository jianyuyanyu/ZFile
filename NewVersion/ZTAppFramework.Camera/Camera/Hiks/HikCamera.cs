...
namespace ZTAppFramework.Camera.Camera.Hiks
{
    ...
    public class HikCamera : ICamera
    {
        ...
        private IDictionary<ECameraParameter, CameraParameter> GetParameterDictionary()
        {
            ...
            var gain = new MyCamera.MVCC_FLOATVALUE();//增益
            var frameRate = new MyCamera.MVCC_FLOATVALUE();//帧速率
            var triggerDelay = new MyCamera.MVCC_FLOATVALUE();//触发器隐藏
