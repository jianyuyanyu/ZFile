...
namespace ZFileApp.Behaviors
{
    ...
    //        page.Content.BackgroundColor = Color.WhiteSmoke;

    //        // Platform specific
    //        page.On<iOS>().SetUseSafeArea(true);
    //    }

    //    protected override void ApplyTabbedPageBehaviors(Xamarin.Forms.TabbedPage page)
    //    {
